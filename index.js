		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de KAKASHIzy. Registre-se para fazer amizade com o bot kakashi por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar KAKASHIzy|17\n\n──「 KAKASHI BOT 」──`,
			...
			const ownerNumber = ["5598987851993@s.whatsapp.net"] // replace this with your number
			...
			const premium = ["5598987851993@s.whatsapp.net","5598987851993@s.whatsapp.net"] 
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("cadebot")){
			client.updatePresence(from, Presence.composing)
			reply("olha eu aqui carai,cego.")
	}
	
		if (messagesC.includes("bot")){
			client.updatePresence(from, Presence.composing)
			reply("oi , que que tu quer ?😠")
	}
			...
			switch(command) {
				...
				case 'menu1':
					...
					if (!isOwner) return reply('Meu dono ?👀?')
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('5598987851993@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS KAKASHIZy BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
                                       ...
                                       if (args[0].startsWith('99991825973')) return reply('Falha ao ligar para o número do bot')
                                       if (args[0].startsWith('98987851993')) return reply('Falha ao ligar para o número do proprietário')
				...
				if (!isGroup) return reply(mess.only.group)
					...
					break
			    case 'owner':
                    client.sendMessage(from, {displayname: "Jeff", vcard: 98987851993}, MessageType.contact, { quoted: mek})
				...
				case 'walpaperanime':
					...
					if (mentioned.length > 1) {
						...
						mentions(`╭────「 *PREMIUM👑* 」──*\n│+ *Número* : @5598987851993${mentioned[0].split('@5598987851993')[0]}\n│+ *Expirado*: *30 Days*\n│+ *Status*: *ATIVO*\n│ Thx para atualizar para premium🥰\n*╰──────「 *posição* 」────`, mentioned, true)
					client.sendMessage(from, mentioned)
				    }
					break
					case 'daftarvip': 
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT KAKASHIZy✨* 」\n*│+ wa.me/5598987851993*╰──────*「 *Kakashi* 」*────*\n\n*_SE QUER SER ADMIN DO BOT KAKASHIZy_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/5598987851993/*╰──────*「 * KAKASHIZy * 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO KAKASHIZy BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do KAKASHI'*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* KAKASHIZy\n*YOUTUBE:*\n*WPP:* wa.me/+5598987851993\n*INSTA:* @__kakashi\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix'
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
